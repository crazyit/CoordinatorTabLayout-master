...
import cn.hugeterry.coordinatortablayout.CoordinatorTabLayoutWithHead;

/**
 * Created by hugeterry(http://hugeterry.cn)
 */
public class MainActivity extends AppCompatActivity {
    private CoordinatorTabLayoutWithHead mCoordinatorTabLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCoordinatorTabLayout = (CoordinatorTabLayoutWithHead) findViewById(R.id.coordinatortablayout);
